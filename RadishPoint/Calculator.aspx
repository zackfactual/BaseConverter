...
<asp:content id="calculatorContent" ContentPlaceHolderID="MainContent" runat="server">
    <div class="container-fluid">
        ...
        <h5 class="text-danger">*Results precise up to 324 fractional digits</h5>
        <h5 class="text-danger">*Warning: letters are case-sensitive (A=10, a=36)</h5>
